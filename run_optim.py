...
data_batch = {"Risk Free Rate": data_collection.getTreasuryReturn(),  # 10 year treasury bond return, can be modified and a value entered manually
                "Number of Iterations": 100,  # Number of times to disturb market for sensitivity checks
                "Volatility": "Low",  # High or Low
                "Return Perturbation": 0.05,  # Perturbation of Market
